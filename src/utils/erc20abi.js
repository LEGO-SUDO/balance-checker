export const erc20ABI = [
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'newBuyFeePercent', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'address', name: 'newMarketingAddress', type: 'address' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'newSellFeePercent', type: 'uint256' },
    ],
